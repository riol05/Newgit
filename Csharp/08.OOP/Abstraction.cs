...
namespace _08.OOP
{
    ...
    public abstract class Animal // abstract 를 붙이면 추상 클래스
    {
        // 추상적인 클래스에서 구체화 할 수 없는 함수는 추상함수로 선언하고 내용을 정의하지 않음
        public abstract void Cry();     // 상위 클래스에서 구체화할 수 없는 함수// 추상 함수
    }
    ...
    public static class Abstraction
    {
        public static void Test()
        {
            ...
            Animal cat = new Cat();             // 추상클래스를 구체화시킨 자식클래스의 인스턴스는 생성가능
            Animal dog = new Dog();
